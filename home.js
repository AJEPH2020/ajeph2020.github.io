...
class Particle {
    ...
    update() {
        ...
        console.log("linearG: " + window.innerWidth/100);

        if (this.directionX > window.innerWidth/100) {
            this.directionX = window.innerWidth/100;
        }
        if (this.directionX < -window.innerWidth/100) {
            this.directionX = -window.innerWidth/100;
        }
        if (this.directionY > window.innerHeight/100) {
            this.directionY = window.innerHeight/100;
        }
        if (this.directionY < -window.innerHeight/100) {
            this.directionY = -window.innerHeight/100;
        }
